...
export default function Main() {
  return (
    <section className="text-black body-font">
          ...
          <div className="text-left">
            <div className="text-left">
              ...
              <p className="text-left leading-relaxed xl:w-3/4 lg:w-3/4 text-gray-500">
                ...
                to implementation. She combines a product designer's sense of
                how aesthetics should serve function with a product owner's
                analytical rigor. She brings order to the chaos that
                characterizes all early project development when one must
                convert ideas into a plan of action. A common thread in all
                Kat's endeavors is iterative research -- she tests hypotheses
                with her suspected audiences, learns their needs, trims away
                anything not needed for the initial personae and then retests.
                But none of this compares to Kat's character and strength. She
                meets even the most enormous challenges with creativity and
                optimism. She sets an example not just for her teammates but for
                the people, like me, who have known her over the years. You
                build great teams around talent but you build great companies
                around character.
              </p>
          ...
          <div className="text-left">
            <div className="text-left">
              ...
              <p className="text-left leading-relaxed xl:w-3/4 lg:w-3/4 text-gray-500">
                ...
                relations and strategic storytelling to overall design systems
                and UX. She approached each project in the same holistic way and
        ...
        <div className="container px-5 py-4 mx-auto">
          <div className="text-left">
            <div className="text-left">
              ...
              <p className="text-left leading-relaxed xl:w-3/4 lg:w-3/4 text-gray-500">
                Kat's visual design prowess and passion for implementing design
                as a practice really up-leveled the couple of projects that we
                worked on together. However, what stuck out to me most is her
                ability to listen, ask the right questions, and build a case for
                better design decisions with her stakeholders. In all of my
                interactions with Kat, I left those conversations feeling like
                the work product or process was significantly improved. Kat is
                well-qualified to lead a design practice and be a trusted
                advisor to senior leaders. She's a joy to work with!
              </p>
        ...
        <div className="container px-5 py-4 mx-auto">
          <div className="text-left">
            <div className="text-left">
              <p className="text-left leading-relaxed xl:w-3/4 lg:w-3/4 text-white lg:text-4xl md:text-2xl font-bold py-6">
                "Kat is a{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-violet-800">
              ...
              <p className="text-left leading-relaxed xl:w-3/4 lg:w-3/4 text-gray-500">
                ...
                worked with her for several years in both an agency setting and
                as a freelancer. I’ve had the pleasure of working with her on
                several freelance projects, our most recent being building the
                branding and website designs for Foxbox. One of Kat’s many
                strengths is being able to articulate a clear design vision
                while seamlessly working with individual contributors to bring
                that vision to life. On any large design project, it’s important
                to have a design leader who understands and communicates the
                needs and priorities of a project while also creating an
                environment that encourages collaboration and feedback. Kat is
                that person and I think any organization can be confident in her
                abilities as a creative director and manager.{" "}
              </p>
              <div className="flex justify-left">
                <p className="justify-left sm:justify-start text-white font-bold pt-8">
      ...
      <section className="bg-sky-400">
        <div className="container px-5 py-px mx-auto"></div>
      </section>
      <section className="bg-emerald-600">
        <div className="container px-5 py-px mx-auto"></div>
      </section>
